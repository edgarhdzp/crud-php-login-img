...
?>	
			...
			<form action="../querys/registrar-inventario.php" method="POST" enctype="multipart/form-data">
				...
				<br>
				<label>DEPARTAMENTO:</label><select name="depa" required>
					...
					<div class="form-group">
					<label for="obs_del">Observacion general:</label>
					<input  type="text" class="form-control" name="obs_del" id="obs_del" required>
					</div>

					<div class="form-group">
					<label for="nom_usu">Nombre de Usurio:</label>
