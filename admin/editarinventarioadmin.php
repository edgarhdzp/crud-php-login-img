...
?>	
			...
			<hr>
			<form action="../querys/actualizarinventarioadmin.php" method="POST" class="form-vertical" role="form" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input value="<?php echo $registro['observacion']; ?>" type="text" class="form-control" name="observacion" id="observacion" required>
				</div>
			...
			<tr><td>Foto: 
 					<?php
      					echo "<img width='350px' height='350px' src='" . $registro['foto'] ."' />";
  					?>
  			</td></tr> 
